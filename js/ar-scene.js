...
function createGreetingPanel() {
  ...
  panel.position.set(0.63, 0.09, 0.52);
...
export class ARExperience {
  ...
  async start() {
    ...
    this.contentRoot.position.set(0, 0.07, 0.10);
    ...
    stage.position.set(0, -0.34, 0.19);
    stage.scale.set(1, 0.82, 1);
    this.contentRoot.add(stage, createStageAccents());
    ...
    chakra.position.set(0.04, -0.23, 0.58);
    this.chakra = chakra;
